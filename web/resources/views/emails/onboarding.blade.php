...
<p style="margin:0 0 28px;font-size:15px;color:#475569;line-height:1.6;">
    An account has been created for you on {{ config('app.name') }}. Click the button below to
    set your password and activate it. This link expires in <strong>72 hours</strong> and can
    only be used once.
</p>
